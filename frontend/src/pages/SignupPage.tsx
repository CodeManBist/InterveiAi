...
function GoogleIcon() {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M12 6.14c1.43 0 2.72.49 3.73 1.45l2.8-2.8C16.84 3.14 14.63 2.25 12 2.25a9.74 9.74 0 0 0-8.7 5.39l3.24 2.53c.77-2.31 2.92-4.03 5.46-4.03Z"
      />
    </svg>
  );
}
...
function SignupPage() {
  ...
  const handleVerification = async (
    ...
    setError("Unable to complete account creation.");
  };
